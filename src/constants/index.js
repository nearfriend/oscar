...
const projects = [
  {
    id: 'project-1',
    name: 'jeetwin',
    description: "JeetWin is one of Asia's most trusted and leading online casinos and sports betting platforms",
    tags: [
      {
        name: 'react',
    ...
    image: jeetwin,
    repo: 'https://www.jeetwin.pro/',
    demo: 'https://www.jeetwin.pro/',
  },
  {
    id: 'project-2',
    name: 'Leaderboard',
  ...
  },
  {
    id: 'project-3',
    name: 'Snapmuse',
    description: 'Snapmuse.io is the web3 funding platform for the entertainment industry.',
    tags: [
      {
        name: 'nextjs',
        color: 'blue-text-gradient',
    ...
    image: Snapmuse,
    repo: 'https://snapmuse.io/',
    demo: 'https://snapmuse.io/',
  },
  {
    id: 'project-4',
    name: 'Movie Metro',
